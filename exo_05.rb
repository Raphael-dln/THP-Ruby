...
# Multiplication du précédent nombre par 60 pour afficher le nombre de minutes
...
# Avec "<", Ruby calcule directement si l'affirmation est vraie ou fausse et affiche le résultat uniquement
puts 3 + 2 < 5 - 7
# La commande #{3 + 2} additionne 3 et 2 et affiche directement le résultat (5) dans le terminal
puts "Ça fait combien 3 + 2 ? #{3 + 2}"
# La commande #{5 -7} soustraint 7 à 5  et affiche directement le résultat (-2) dans le terminal
